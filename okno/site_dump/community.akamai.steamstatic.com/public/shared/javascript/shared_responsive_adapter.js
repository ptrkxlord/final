		...
		$SelectBox.append(
			$J('<option/>', {value: "russian"} ).text( 'Русский (Russian)' )
				...
				$J('<option/>', {value: "english"} ).text( 'English (английский)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español - España (испанский — Испания)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "latam"} ).text( 'Español - Latinoamérica (испанский — Латинская Америка)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "polish"} ).text( 'Polski (польский)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (португальский — Португалия)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "brazilian"} ).text( 'Português-Brasil (португальский — Бразилия)' )
			);
					$SelectBox.append(
